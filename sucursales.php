...
<body>
            ...
            <div class="content">
                <div class="page-header">
                    <div class="page-title">
                        <h4>Sucursales</h4>
                        <h6>Control de Sucursales y las Existencias de los Productos de las Sucursales de la Muebleria
                        </h6>
                    </div>
                </div>
                <div class="card">
                            ...
                            <div class="wordset">
                                <ul>
                                    ...
                                    <li class="acceso-inventario">
                                        <a onclick="inventyario()" data-bs-toggle="tooltip" data-bs-placement="top"
                        ...
                        <div class="table-responsive">
                            <table class="table datanew">
                                ...
                                <tbody>
                                    ...
                                    $consulta1 = "CALL obtenerSucursales();";
                                    ...
                                    while ($tabla1 = mysqli_fetch_array($ejecutarconsulta1)) {
                                        ...
                                        <tr>
                                            <td>
                                                <label class="checkboxs">
                                                    <input type="checkbox"
                                                        onclick="togglePopupGestionSucursales('<?php echo $tabla1[0]; ?>', '<?php echo $tabla1[1]; ?>')">
                                                    <span class="checkmarks"></span>
                                                </label>
                                            </td>
                                            ...
                                            <td>
                                                <span class="badges bg-lightgreen eliminar-boton">
                                                    <a href="#"
                                                        onclick="togglePopupEliminarSucursal('<?php echo $tabla1[0]; ?>')">ELIMINAR</a>
                                                </span>
                                            </td>
                                            <td>
                                                <span class="badges bg-lightgreen">
                                                    <a href="#"
                                                        onclick="imprimirListaProductos('<?php echo $tabla1[0]; ?>', '<?php echo $tabla1[1]; ?>')">IMPRIMIR</a>
                                                </span>
                                            </td>
                                        </tr>
                                        <?php
    ...
    <script src="assets/js/modificar_sucursal.js"></script>
    <script src="assets/js/eliminar_sucursal.js"></script>
...
<div id="popupGestionSucursales" class="popup">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="page-title">
                        ...
                        <h7>Gestion y Modificacion de Informacion General de la Sucursal</h7>
                    </div>
                    <br>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <div class="form-group">
                                <label style="font-weight: normal">Id Sucursal</label>
                                <input type="text" id="claveSucursal1" readonly>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <div class="form-group">
                                <label style="font-weight: normal">Ubicaicon Sucursal</label>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-3 col-sm-3 d-flex justify-content-center align-items-center">
                            <div class="form-group">
                                <button type="insertarProductoBtn" class="btn btn-primary" data-bs-toggle="tooltip"
                                    data-bs-placement="top" title="Insertar Productos a la Sucursal"
                                    id="insertarProductoBtn" onclick=" redirectToSucursalProductos()">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 d-flex justify-content-center align-items-center">
                            <div class="form-group">
                                <button type="buttonEliminarCa" class="btn btn-primary" data-bs-toggle="tooltip"
                                    data-bs-placement="top" title="Gestion de Productos por Sucursal" id="gestionProd"
                                    onclick=" redirectToGestionSucursales()">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 d-flex justify-content-center align-items-center">
                            <div class="form-group">
                                <button type="submit" class="btn btn-primary" data-bs-toggle="tooltip"
                                    data-bs-placement="top" title="Actualizar Datos Sucursal"
                                    onclick="actualizarSucursal(event)">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 d-flex justify-content-center align-items-center">
                            <div class="form-group">
                                <button type="buttonEliminarCa" class="btn btn-primary" data-bs-toggle="tooltip"
                                    data-bs-placement="top" title="Cancelar Operaciones" id="closePopupGestionSucursal">
                ...
                <div class="card-body">
                    <form id="formAgregarProducto">
                        <div class="page-title">
                            ...
                            <h7>Registra Nueva Sucursal para la Muebleria</h7>
                        </div>
                        <br>
                        <!-- Copiado exactamente como tu formulario original -->
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <div class="form-group">
                                    <label style="font-weight: normal">Ubicacion de la Sucursal</label>
                                    <input type="text" id="ubicacionSucursal">
                                </div>
                            </div>
                        </div>
                        <div class="row">
...
<div id="popupEliminarSucursal" class="popup" style="display: none;">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <label id="sucursalIdLabel" class="form-label">ID Sucursal:</label>
                        </div>
                    </div>
                    <br>
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <div class="form-group">
                                <button type="submit" class="btn btn-primary" data-bs-toggle="tooltip"
                                    data-bs-placement="top" title="Dar de Baja Sucursal" id="btnEliminarSucursal">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <div class="form-group">
                                <button type="button" class="btn btn-primary" data-bs-toggle="tooltip"
                                    data-bs-placement="top" title="Cancelar" id="closePopupEliminarSuc">
