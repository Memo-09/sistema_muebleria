...
<head>
    ...
    <title>Insertar a Sucursal</title>
...
<body>
            ...
            <div class="content">
                <div class="page-header">
                    <div class="page-title">
                        <h4>Insertar Productos a Sucursal</h4>
                        <h6>Inserta los Productos que Contendra la Nueva Sucursal</h6>
                    </div>
                </div>
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <div class="form-group">
                                    <button type="submit" id="btnGuardar" class="btn btn-primary" onclick="AgregarTodosLosProductos()">AGREGAR TODOS LOS PRODUCTOS</button>
                                </div>
                            </div>
                        </div>
                        <br>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 d-flex justify-content-center align-items-center">
                                <div class="form-group">
                                    <button type="submit" id="btnGuardar" class="btn btn-primary"
                                        data-bs-toggle="tooltip" data-bs-placement="top" title="Guardar Productos en la Sucursal"
                                        onclick="guardarProductoSucursal()">
    ...
    <script src="assets/js/producto_sucursal.js"></script>
