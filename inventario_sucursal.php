...
class PDF extends FPDF {
    ...
    function Header() {
        ...
        $this->Cell(0, 6, 'INVENTARIO DE SUCURSAL', 0, 1, 'C');
...
$pdf->Cell(40, 6, 'Clave de Sucursal:', 1, 0, '', true);
...
$nombre_archivo = 'INVENTARIO_SUCURSAL_' . strtoupper($fecha_actual) . '.pdf'; // Convertir la fecha a mayúsculas
