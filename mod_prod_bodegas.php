...
<head>
    ...
    <title>Gestionar Productos a Bodegas</title>
...
<body>
            ...
            <div class="content">
                <div class="page-header">
                    <div class="page-title">
                        <h4>Gestion de Bodegas y sus Productos</h4>
                        <h6>Control de Productos y su Bodega</h6>
                    </div>
                </div>
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="form-group">
                                <input type="text" id="nombreProductoBuscador" placeholder="Buscar Producto en la Bodega">
                            </div>
                        </div>
    ...
    <script src="assets/js/funcion_tabla_7.js"></script>
    <script src="assets/js/funcion_eliminar_tabla_bod.js"></script>
    <script src="assets/js/funcion_actualizar_existencias2.js"></script>
