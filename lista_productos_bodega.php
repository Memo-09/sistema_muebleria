...
class PDF extends FPDF {
    ...
    function Header() {
        ...
        $this->Cell(0, 6, 'LISTA DE PRODUCTOS POR BODEGA', 0, 1, 'C');
...
if ($idSucursal) {
    ...
    $pdf->Cell(0, 6, 'Clave de la Bodega: ' . utf8_decode($idSucursal), 0, 1);
    ...
    while ($fila = $resultado_productos->fetch_assoc()) {
        ...
        // Sumar las existencias y contar los productos
        $contador_productos++;
    ...
    $fecha = date("Y-m-d");
    $archivo_pdf = "LISTA_PRODUCTOS_BODEGA_{$idSucursal}_$fecha.pdf";
