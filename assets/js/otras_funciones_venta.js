...
document.getElementById('toggleCargoAdicional').addEventListener('change', function () {
    const campoCargo = document.getElementById('cargoAdicional');
...
document.getElementById('agregarCargo').addEventListener('click', function () {
    const campoCredito = document.getElementById('credito1');
    ...
    campoCargo.value = '';
    campoCargo.disabled = true;
    document.getElementById('toggleCargoAdicional').checked = false;
});