...
document.addEventListener("DOMContentLoaded", function() {
    ...
    if (imprimirButton) {
        imprimirButton.addEventListener("click", function() {
            ...
            const colaboradorTexto = document.getElementById("ComboColaborador4").options[document.getElementById("ComboColaborador3").selectedIndex].text;
            ...
            if (colaborador !== "seleccion") {
                ...
                const url = `generar_estadisticas.php?colaborador_value=${encodeURIComponent(colaborador)}&colaborador_texto=${encodeURIComponent(colaboradorTexto)}&dia_texto=${encodeURIComponent(diaTexto)}`;
