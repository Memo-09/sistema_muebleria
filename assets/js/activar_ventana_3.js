function togglePopupGestionSucursales(claveSucursal, Ubicacion) {
    // Mostrar la ventana emergente
    const popup = document.getElementById("popupGestionSucursales");
    ...
    xhr.open("POST", baseURL + "/funciones_base/consultarProductos.php", true);
    ...
    xhr.onload = function () {
        ...
        try {
            ...
            if (response.error) {
                ...
                console.log('Cantidad de productos asociados a la sucursal:', cantidadProductos);
