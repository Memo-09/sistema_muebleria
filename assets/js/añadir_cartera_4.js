document.addEventListener("DOMContentLoaded", function () {
    ...
    function manejarYGuardarAnticipo(anticipo, restanteActual, row, idVenta) {
        ...
        // Calcular el nuevo restante antes de enviar la petición
        ...
        xhr.onreadystatechange = function() {
            if (xhr.readyState == 4 && xhr.status == 200) {
                ...
                if (response.indexOf("No se puede registrar el anticipo") !== -1) {
                    ...
                    // Si la respuesta es exitosa, actualizar el restante
        ...
        xhr.send("idVenta=" + encodeURIComponent(idVenta) + 
                "&anticipo=" + encodeURIComponent(anticipo) + 
                "&nuevoRestante=" + encodeURIComponent(nuevoRestante));
    }
});