function enviarDatos() {
    ...
    var enganche = document.getElementById('enganche_total').value;
    var dia = document.getElementById('Combodia').value;
    var tipopago = document.getElementById('ComboTipoPago').value;
    var parcial = document.getElementById('ComboParcial').value;
    var enganche_dado = document.getElementById('enganche').value;
    ...
    if (tipopago === "seleccion" || tipopago === "") {
        alert("Por favor, selecciona un Tipo de Pago");
        return; // Detener la ejecución si el cliente no está seleccionado
    }

    if (parcial === "seleccion" || parcial === "") {
        alert("Por favor, selecciona una Parcial");
        return; // Detener la ejecución si el cliente no está seleccionado
    }
    ...
    if (credito === "" || creditoContado === "" || contado === "" || 
        ...
        pagoMinimo === "" || pagoMaximo === "" || enganche === "" || enganche_dado === "") {
