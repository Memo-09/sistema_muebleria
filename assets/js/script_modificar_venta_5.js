...
function sumarCreditos() {
    ...
    const enganche = document.getElementById("Enganche1"); // Input de contado con 30% de descuento
...
function actualizarPrecios() {
    ...
    var enganche1Element = document.getElementById('Enganche1');
    ...
    var enganche1 = parseFloat(enganche1Element.value) || 0;
