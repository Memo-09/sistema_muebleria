...
function obtenerDatosColaborador(idColaborador) {
    ...
    .then(data => {
        ...
        if (data.length === 0) {
            alert("El colaborador no cuenta con clientes en su Cartera de Clientes.");
    ...
    fetch(baseURL + "/funciones_base/obtener_clientes_dia.php", {
        ...
        .then(data => {
            ...
            if (data && Array.isArray(data) && data.length > 0) {
                ...
                alert("No se encontraron clientes en su Cartera de Clientes para este Dia");
