            ...
            <div class="content">
                <div class="page-header">
                    <div class="page-title">
                        <h4>Deudores</h4>
                        <h6>Lista de deudores con sus pagos pendientes.</h6>
                    </div>
                </div>
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table datanew">
                                ...
                                <tbody>
                                    ...
                                    $consulta1 = "CALL obtener_ventas_deudores();";
                                    ...
                                    ?>
                                        <tr>
                                            <td>
                                                <label class="checkboxs">
                                                    <input type="checkbox"
                                                        onclick="togglePopupDetalleVenta('<?php echo $tabla1[0]; ?>','<?php echo $tabla1[1]; ?>','<?php echo $tabla1[2]; ?>','<?php echo $tabla1[3]; ?>','<?php echo $tabla1[4]; ?>','<?php echo $tabla1[5]; ?>','<?php echo $tabla1[6]; ?>','<?php echo $tabla1[7]; ?>','<?php echo $tabla1[8]; ?>','<?php echo $tabla1[9]; ?>',)">
                                                    <span class="checkmarks"></span>
                                                </label>
                                            </td>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 d-flex justify-content-center align-items-center">
                            <div class="form-group">
                                <button type="submit" class="btn btn-primary" data-bs-toggle="tooltip"
                                    data-bs-placement="top" title="Quitar de Deeudores" onclick="quitardeDeudores()">
                                    <img src="./assets/img/regreso.png" alt="">
                                </button>
                            </div>
                        </div>
                    </div>
