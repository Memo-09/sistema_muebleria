...
<head>
    ...
    <title>Gestionar Productos a Sucursal</title>
...
<body>
            ...
            <div class="content">
                <div class="page-header">
                    <div class="page-title">
                        <h4>Gestion de Sucursal y sus Productos</h4>
                        <h6>Control de Productos y su Sucursal</h6>
                    </div>
                </div>
                <div class="card">
                    <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="claveSucursal" value="<?php echo $id ?>" readonly>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    <div class="form-group">
                                        <label style="font-weight: normal">Ubicación Sucursal</label>
                        ...
                        <div class="table-responsive">
                            <table class="table datanew" id="tabla1">
                                ...
                                <tbody>
                                    ...
                                    $consulta1 = "CALL ObtenerProductosSucursal2();";
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?php echo $tabla1[1] . "," . $tabla1[2] . ",MARCA " . $tabla1[3]; ?></td>
                                            <td>
                                                <span>
                                                    <a href="#" class="btn btn-success btn-sm fw-bold agregar-btn">AGREGAR</a>
                                                </span>
                                            </td>
                                        </tr>
                                    <?php
                        ...
                        <h7>Lista de Productos por su Sucursal</h7>
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="form-group">
                                <input type="text" id="nombreProductoBuscador" placeholder="Buscar Producto en la Sucursal">
                            </div>
                        </div>
                        <div class="table-responsive2">
                            <table class="table" id="tabla2">
                                ...
                                <tbody>
                                    ...
                                    // Recuperar datos del procedimiento almacenado
                                    $consulta2 = "CALL ObtenerProductosSucursal3($id);";
                                    $ejecutarconsulta2 = mysqli_query($conexion, $consulta2);

                                    while ($tabla3 = mysqli_fetch_array($ejecutarconsulta2)) {
                                    ?>
                                        <tr data-clave="<?php echo $tabla3[1]; ?>">
                                            <td><?php echo $tabla3[1]; ?></td>
                                            <td><?php echo $tabla3[2] . " " . $tabla3[3] . ",MARCA " . $tabla3[4]; ?></td>
                                            <td><input type="text" name="existencias" value="<?php echo $tabla3[5]; ?>" class="form-control" style="width: 50px;" /></td>
                                            <td>
                                                <span>
                                                    <a href="#" class="btn btn-success btn-sm fw-bold eliminar-btn2">ELIMINAR</a>
                                                </span>
                                            </td>
                                            <td>
                                                <span>
                                                    <a href="#" class="btn btn-success btn-sm fw-bold actualizar-btn">ACTUALIZAR EXISTENCIAS</a>
                                                </span>
                                            </td>
                                        </tr>
                                    <?php
    ...
    <script src="assets/js/funcion_tabla_6.js"></script>
    <script src="assets/js/funcion_eliminar_tabla.js"></script>
    <script src="assets/js/funcion_actualizar_existencias.js"></script>
    ...
    <script src="assets/js/buscador_sucursal_bodega.js"></script>
